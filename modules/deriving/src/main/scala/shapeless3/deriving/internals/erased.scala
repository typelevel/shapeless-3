...
final class ErasedProductInstances1[K, FT](mirror: Mirror.Product, i0: () => Any) extends ErasedProductInstances[K, FT]:
...
DO NOT USE as it will lead to stack overflows when deriving instances for recursive types.""")
  ...
  def erasedFoldLeft(x: Any)(a: Any)(f: (Any, Any, Any) => CompleteOr[Any]): Any =
    f(a, i, toElement(x)) match
      case Complete(r) => r
      case acc => acc

  def erasedFoldLeft2(x: Any, y: Any)(a: Any)(f: (Any, Any, Any, Any) => CompleteOr[Any]): Any =
    f(a, i, toElement(x), toElement(y)) match
      case Complete(r) => r
      case acc => acc

  def erasedFoldRight(x: Any)(a: Any)(f: (Any, Any, Any) => CompleteOr[Any]): Any =
    f(i, toElement(x), a) match
      case Complete(r) => r
      case acc => acc

  def erasedFoldRight2(x: Any, y: Any)(a: Any)(f: (Any, Any, Any, Any) => CompleteOr[Any]): Any =
    f(i, toElement(x), toElement(y), a) match
      case Complete(r) => r
      case acc => acc

  def erasedProject(x: Any)(p: Int)(f: (Any, Any) => Any): Any =
    f(i, toElement(x))
...
final class ErasedProductInstancesN[K, FT](mirror: Mirror.Product, is0: () => Array[Any])
...
DO NOT USE as it will lead to stack overflows when deriving instances for recursive types.""")
  ...
  def erasedFoldRight(x0: Any)(i: Any)(f: (Any, Any, Any) => CompleteOr[Any]): Any =
    val n = is.length
    if n == 0 then i
    else
      val x = toProduct(x0)
  ...
  def erasedFoldRight2(x0: Any, y0: Any)(i: Any)(f: (Any, Any, Any, Any) => CompleteOr[Any]): Any =
    val n = is.length
    if n == 0 then i
    else
      val x = toProduct(x0)
...
object ErasedProductInstances:
  ...
  private val emptyArray: Array[Any] = new Array(0)
